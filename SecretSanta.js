...
SecretSanta.prototype.generate = function () {
    ...
    while ( Object.keys( candidatePairings ).length > 0 ) {
        ...
        if ( candidatePairings[ name ].length === 0 )
            throw new Error('I haven\'t been able to find a match for ' + name + '! Press "Generate" to try again and, if it still doesn\'t work, try removing some exclusions from your rules. Sorry for the inconvenience!');
